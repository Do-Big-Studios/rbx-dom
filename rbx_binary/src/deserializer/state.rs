...
rbx-dom may require changes to fully support this property. Please open an issue at https://github.com/Do-Big-Studios/rbx-dom/issues and show this warning.",
                                    type_info.type_name,
                                    err
                                );
